...
my_table <- data.frame()
for(i in 1:10) {
  my_result <- my_knn_cv(train = penguins, cl = penguins$species, k_nn = i, k_cv = 5 )
  my_table[1,i] <- my_result$cv_err
  my_table[2,i] <- sum(as.numeric(penguins$species != my_result$class)) / nrow(penguins)
}
...
for(i in 1:30) {
  ...
  my_table_1[2,i] <- unlist(result) / nrow(penguins)
}
...
for(i in 1:30) {
  ...
  my_table_2[2,i] <- unlist(result) / nrow(penguins)
}
...
for(i in 1:30) {
  ...
  my_table_3[2,i] <- unlist(result) / nrow(penguins)
}
