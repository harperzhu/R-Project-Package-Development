...
require(gridExtra)
#plot for k=2
plot1 <- ggplot(my_table_1, aes(x=MSE, y=cv_err)) + geom_boxplot(outlier.colour="red", outlier.shape=8, outlier.size=4)+ theme_bw()
#plot for k=5
plot2 <- ggplot(my_table_2, aes(x=MSE, y=cv_err)) + geom_boxplot(outlier.colour="red", outlier.shape=8, outlier.size=4)+ theme_bw()
#plot for k=10
plot3 <- ggplot(my_table_3, aes(x=MSE, y=cv_err)) + geom_boxplot(outlier.colour="red", outlier.shape=8, outlier.size=4) + theme_bw()
