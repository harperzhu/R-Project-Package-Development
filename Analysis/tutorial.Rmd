...
#plot for k=2
graph_1<- ggplot(my_table_1, aes(x=MSE, y=cv_err)) + geom_boxplot(outlier.colour="red", outlier.shape=8, outlier.size=4)
#plot for k=5
graph_2<- ggplot(my_table_2, aes(x=MSE, y=cv_err)) + geom_boxplot(outlier.colour="red", outlier.shape=8, outlier.size=4)
#plot for k=10
graph_3<- ggplot(my_table_3, aes(x=MSE, y=cv_err)) + geom_boxplot(outlier.colour="red", outlier.shape=8, outlier.size=4)
 ggsave(path = "../Output/Figures", filename = "graph_1.jpg")
 ggsave(path = "../Output/Figures", filename = "graph_2.jpg")
 ggsave(path = "../Output/Figures", filename = "graph_3.jpg")
 my_table_1 <- as.data.frame(my_table_1)
 my_table_2 <- as.data.frame(my_table_2)
 my_table_3 <- as.data.frame(my_table_3)
simulation <- write_csv(merge(my_table_1,my_table_2, my_table_3), file = "../Output/Result/simulation.csv")
```
